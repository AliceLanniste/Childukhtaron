...
label after_menu_pray:
    ...
    play music "audio/bgm/1-3-room-now-1.mp3" fadein 1.0
    ...
    play music3 "28_foley_clock_chime_02.ogg"
    ...
    play music2 "audio/bgm/2.0-forest.mp3" fadein 1.0
    "离开校舍后，你的身影消失在树林中。"
    ...
    extend "\n这么冷的天气，{w=0.3}谁会到这禁林……"
    extend"等等，这居然有个礼堂？"
    play sound "41_whoosh_transition_05.ogg"
    ...
    play sound  "42_whoosh_transition_06.ogg"
    scene bg pool
    with fade

    play music2 "audio/bgm/3.1-pool.mp3" fadein 1.0
    ...
    peter "好了，唉！{w=0.3}强盗先生您的{outlinecolor=#a55800}“脸”{/outlinecolor}，还有这衬衫\n{w=0.6}先生，看来是没有一点悔意的！"
    player "放了你鸽子，对不起[peter.name]……我也想当一次有姓名的人物……"
    peter "……"
    stop music fadeout 1.0
    play sound "44_human_girl_laugh.ogg"
    play sound2 "45_whoosh_bell_chime.ogg" 
    show screen show_image_with_frame_and_fade("other/cloika_dancing_girls.png") with Dissolve(1.0)
    "水池旁围伴着三位少女。\n{w=0.6}她们一边旋转着，{w=0.3}一边唱着音调怪异的曲子"
    #play music "46_human_girl_murmur.ogg"
    play music3 "audio/bgm/3.2-pool-dancing girl-2.mp3" fadein 1.0
    ...
    #play sound "47_human_crowd_gasp.ogg"
    ...
    player "所有人都注视着她……"
    play sound "48_foley_bell_double.ogg"
    #play sound "20_impact_eye_appear.ogg"
...
label after_drag_rope:
    ...
    #play sound "55_cloth_curtain_move.ogg"_这个音效感觉没必要，有点影响集中注意力
    show curtain_left:
        linear 5.0 xpos -960
    show curtain_right:
        linear 5.0 xpos 1920

    play sound "54_whoosh_camera_pan.ogg"  
    ...
    player "嗯？应当不会吧……"
    play sound "58_glass_fork_clink.ogg" #这里需要三声，和【音效】协调
    pause 1.0
    stop music 
    play music "59_amb_banquet_02.mp3"
    ...
    play music "63_impact_flicker_buzz.mp3"
    ...
    show bg statue_eyes:
        ...
        linear 30 zoom 2 
    "如果你望向神明的眼，能看见多少灵魂？{w=3.0}{nw}"
    "是密密麻麻地许多，纷纷住满荒唐的念头，相互纠缠着打成死结?\n{w=1.0}或是孤零零的伫着，浑浊得可以囊括无数颜色。{w=3.0}{nw}"
    "这死寂而无情的神眼，\n如永恒的镜湖，将真相沉溺。{w=3.0}{nw}"
    "直到浸泡其中的灵魂之尸们在日夜不甘中膨胀，\n{w=1.0}不受控地上浮，让腐烂已久的情绪得以呼吸。{w=3.0}{nw}"
    show dark_red at fade_in(5.0)
    "戏剧在永恒中绮丽{w=3.0}{nw}"
    $ renpy.pause(1.0, hard=True)
    "奇尔杜克塔伦山谷在静默中凄鸣{w=4.0}{nw}"
    play sound "54_whoosh_camera_pan.ogg"  #暂时放的，不用管
